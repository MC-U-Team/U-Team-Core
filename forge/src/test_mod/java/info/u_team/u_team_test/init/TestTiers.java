...
public class TestTiers {
	...
	public static final ExtendedTier BASIC = new UForgeExtendedTier(new float[] { 8, 0, 4, 2, 6 }, new float[] { -3.1F, -1, -2, -2, 0 }, TagUtil.createBlockTag(TestMod.MODID, "needs_basic_tier"), 500, 10F, 8, 30, () -> Ingredient.of(TestItems.BASIC.get()));
