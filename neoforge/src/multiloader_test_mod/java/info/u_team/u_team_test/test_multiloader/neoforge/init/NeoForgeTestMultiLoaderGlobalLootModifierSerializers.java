...
public class NeoForgeTestMultiLoaderGlobalLootModifierSerializers {
	...
	public static final CommonRegister<MapCodec<? extends IGlobalLootModifier>> GLOBAL_LOOT_MODIFIER_SERIALIZERS = CommonRegister.create(NeoForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, TestMultiLoaderReference.MODID);
