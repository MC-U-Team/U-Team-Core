...
public class TestItems {
	...
	public static final ArmorSet BASIC_ARMOR = ArmorSetCreator.create(ITEMS, "basic_armor", new Properties().rarity(Rarity.RARE).fireResistant(), () -> TestArmorMaterials.BASIC.getHolder(), 10);
