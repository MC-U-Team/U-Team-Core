...
public class FabricFoodProperties extends FoodProperties {
	
	private final List<Pair<Supplier<MobEffectInstance>, Float>> effects;
	
	FabricFoodProperties(int nutrition, float saturationModifier, boolean isMeat, boolean canAlwaysEat, boolean fastFood, List<Pair<Supplier<MobEffectInstance>, Float>> effects) {
	...
	public static class Creator implements UFoodPropertiesBuilder.Creator {
		...
		public FoodProperties create(int nutrition, float saturationModifier, boolean isMeat, boolean canAlwaysEat, boolean fastFood, List<Pair<Supplier<MobEffectInstance>, Float>> effects) {
			return new FabricFoodProperties(nutrition, saturationModifier, isMeat, canAlwaysEat, fastFood, effects);
		}
	}
}