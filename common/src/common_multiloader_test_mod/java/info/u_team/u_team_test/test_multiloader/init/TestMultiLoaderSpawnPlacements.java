...
public class TestMultiLoaderSpawnPlacements {
	...
	public static final SpawnPlacementRegister SPAWN_PLACEMENTS = Util.make(SpawnPlacementRegister.create(), spawnPlacements -> {
		spawnPlacements.register(TestMultiLoaderEntityTypes.TEST_LIVING, SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, TestLiving::checkTestLivingSpawnRules);
	});
