...
public class TestMultiLoaderBlockEntityTypes {
	...
	public static final RegistryEntry<BlockEntityType<TestInventoryBlockEntity>> TEST_INVENTORY = BLOCK_ENTITY_TYPES.register("test_inventory", () -> BlockEntityType.Builder.of(TestInventoryBlockEntity::new, TestMultiLoaderBlocks.TEST_INVENTORY.get()));
