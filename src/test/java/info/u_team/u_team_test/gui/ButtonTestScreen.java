...
//		addButton(new ImageButton(10, 70, 16, 16, TEXTURE1, 0xC3272BFF, 0x4286f4FF, button -> System.out.println("Pressed ImageButton")));
		...
		ActiveImageButton activeImageButtonC = addButton(new ActiveImageButton(10, 125, 20, 20, TEXTURE1, 0x296400FF, 0x0c1a99FF, 0x990c99F0));
		activeImageButtonC.setPressable(() -> {
			System.out.println("Pressed ActiveImageButton Coloring");
			activeImageButtonC.setActive(!activeImageButtonC.isActive());
		});
		
//		ToggleImageButton toggleImageButton = addButton(new ToggleImageButton(10, 160, 20, 20, TEXTURE1, TEXTURE2));
