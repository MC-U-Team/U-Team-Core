...
public class TestEntityTypes {
	...
	public static final EntityType<EntityBetterEnderPearl> better_enderpearl = UEntityType.UBuilder.<EntityBetterEnderPearl> create("better_enderpearl", EntityBetterEnderPearl::new, EntityClassification.MISC).size(0.25F, 0.25F).setTrackingRange(128).setUpdateInterval(20).setShouldReceiveVelocityUpdates(true).build();
