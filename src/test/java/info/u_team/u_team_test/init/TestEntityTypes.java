...
public class TestEntityTypes {
	...
	public static final RegistryObject<EntityType<TestLivingEntity>> TEST_LIVING = ENTITY_TYPES.register("test_living", () -> EntityType.Builder.<TestLivingEntity> create(TestLivingEntity::new, EntityClassification.MONSTER).size(0.6F, 1.95F).setTrackingRange(8).setUpdateInterval(20).setShouldReceiveVelocityUpdates(true));
