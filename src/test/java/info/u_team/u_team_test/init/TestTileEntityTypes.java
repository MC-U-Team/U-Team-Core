...
public class TestTileEntityTypes {
	...
	public static final TileEntityType<TileEntityTileEntity> tileentity = null;//TileEntityType.Builder.create("tileentity", TileEntityTileEntity::new, TestBlocks.tileentity).build();
