...
public class TestTileEntityTypes {
	...
	public static final TileEntityType<TileEntityTileEntity> tileentity = UTileEntityType.UBuilder.create("tileentity", TileEntityTileEntity::new, TestBlocks.tileentity).build();
