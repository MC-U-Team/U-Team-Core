...
public class TestScreens {
	...
	private static void register(RegisterMenuScreensEvent event) {
		event.registerScreen(TestContainers.BASIC, BasicTileEntityScreen::new);
		event.registerScreen(TestContainers.BASIC_ENERGY_CREATOR, BasicEnergyCreatorScreen::new);
		event.registerScreen(TestContainers.BASIC_FLUID_INVENTORY, BasicFluidInventoryScreen::new);
	}
