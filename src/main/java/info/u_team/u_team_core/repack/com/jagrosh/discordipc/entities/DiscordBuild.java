...
public enum DiscordBuild {
	...
	/**
	 * 'Wildcard' build constant used in {@link com.jagrosh.discordipc.IPCClient#connect(DiscordBuild...) IPCClient#connect(DiscordBuild...)} to signify that the build to target is not important, and that the first valid build will be used.
	 * <p>
	 *
