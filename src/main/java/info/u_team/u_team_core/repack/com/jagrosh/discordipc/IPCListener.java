...
public interface IPCListener {
	 ...
	 *
	 * @param client
	 *            The IPCClient sending the Packet.
	 * @param packet
	 ...
	 *
	 * @param client
	 *            The IPCClient receiving the Packet.
	 * @param packet
	 ...
	 *
	 * @param client
	 *            The IPCClient receiving the event.
	 * @param secret
	 *            The secret of the event, determined by the implementation and specified by the user.
	 */
	 ...
	 * <p>
	 *
	 * As opposed to {@link #onActivityJoin(IPCClient, String)}, this also provides packaged {@link User} data.
	 *
	 * @param client
	 *            The IPCClient receiving the event.
	 * @param secret
	 *            The secret of the event, determined by the implementation and specified by the user.
	 * @param user
	 *            The user who clicked the clicked the event, containing data on the account.
	 */
	 ...
	 *
	 * @param client
	 *            The now closed IPCClient.
	 * @param json
	 *            A {@link JSONObject} with close data.
	 */
	default void onClose(IPCClient client, JSONObject json) {
	}
	
	/**
	 * Fired whenever an {@link IPCClient} has disconnected, either due to bad data or an exception.
	 *
	 * @param client
	 *            The now closed IPCClient.
	 * @param t
	 *            A {@link Throwable} responsible for the disconnection.
	 */
