...
public interface IPCListener {
	 ...
	 * @param secret
	 *            The secret of the event, determined by the implementation and
	 ...
	 *            specified by the user.
	 * @param user
	 *            The user who clicked the clicked the event, containing data on the
	 *            account.
	 */
	...
	/**
	 * Fired whenever an {@link IPCClient} has disconnected, either due to bad data
	 * or an exception.
	 *
	 * @param client
	 *            The now closed IPCClient.
