...
public class BetterFontSlider extends Slider {
	...
	protected void func_230441_a_(MatrixStack matrixStack, Minecraft minecraft, int x, int y) {
		if (field_230694_p_) {
			if (dragging) {
				sliderValue = (x - (field_230690_l_ + 4)) / (float) (field_230688_j_ - 8);
				updateSlider();
			}
			GuiUtils.drawContinuousTexturedBox(field_230687_i_, field_230690_l_ + (int) (sliderValue * (field_230688_j_ - 8)), field_230691_m_, 0, 66 + (func_230449_g_() ? 20 : 0), 8, field_230689_k_, 200, 20, 2, 3, 2, 2, func_230927_p_());
		}
	}
