...
public class UCoreRecipeSerializers {
	...
	public static final RegistryObject<USpecialRecipeSerializer<DyeableItemDyeRecipe>> CRAFTING_SPECIAL_ITEMDYE = RECIPE_SERIALIZERS.register("crafting_special_itemdye", () -> new USpecialRecipeSerializer<>("crafting_special_itemdye", DyeableItemDyeRecipe::new));
