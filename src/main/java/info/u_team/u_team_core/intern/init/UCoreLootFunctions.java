...
public class UCoreLootFunctions {
	...
	public static final CommonDeferredRegister<LootItemFunctionType> LOOT_FUNCTIONS = CommonDeferredRegister.create(Registry.LOOT_FUNCTION_REGISTRY, UCoreMod.MODID);
