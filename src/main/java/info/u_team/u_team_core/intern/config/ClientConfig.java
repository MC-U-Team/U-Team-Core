...
public class ClientConfig {
	...
	private ClientConfig(Builder builder) {
		...
		discordRichPresence = builder.comment("If you have discord installed it will show your some details about your game as rich presence").define("discordRichPresence", false);
		builder.pop();
	}
