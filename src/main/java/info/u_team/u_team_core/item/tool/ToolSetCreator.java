...
public class ToolSetCreator {
	...
	public static ToolSet create(DeferredRegister<Item> register, String name, Properties properties, IToolMaterial material) {
		return create(register, name, null, properties, material);
	}
	
	public static ToolSet create(DeferredRegister<Item> register, String name, ItemGroup group, Properties properties, IToolMaterial material) {
