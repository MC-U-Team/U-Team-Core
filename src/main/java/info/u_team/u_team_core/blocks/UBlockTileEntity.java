...
import info.u_team.u_team_core.blocks.tileentity.UTileEntity;
...
public class UBlockTileEntity extends UBlock implements ITileEntityProvider{
	...
	public UBlockTileEntity(@Nonnull Material materialIn, @Nonnull String name, @Nullable UCreativeTab tab, 
			                @Nullable Class<? extends UItemBlock> clazz) {
		super(materialIn, name, tab, clazz);
	}
	
	public UBlockTileEntity(@Nullable Class<? extends UTileEntity> tileclazz, @Nonnull Material materialIn, 
			                @Nonnull String name, @Nullable UCreativeTab tab) {
		this(tileclazz, materialIn, name, tab, UItemBlock.class);
	}
	
	public UBlockTileEntity(@Nullable Class<? extends UTileEntity> tileclazz, @Nonnull Material materialIn, @Nonnull String name, 
			                @Nullable UCreativeTab tab, @Nullable Class<? extends UItemBlock> clazz) {
		super(materialIn, name, tab, clazz);
