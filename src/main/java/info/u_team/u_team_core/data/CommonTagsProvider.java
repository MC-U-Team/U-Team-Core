...
public abstract class CommonTagsProvider<T> extends CommonProvider {
	...
	public void act(DirectoryCache cache) {
		...
		tagToBuilder.forEach((location, builder) -> {
			final List<ITag.Proxy> list = builder.func_232963_b_(/* id -> tagToBuilder.containsKey(id) ? Tag.func_241284_a_() : null */id -> Tag.func_241284_a_(), id -> registry.getValue(id).orElse(null)).collect(Collectors.toList());
			if (!list.isEmpty()) {
